...
class MyUtil{ //클래스하나에 여러개 메소드 생성가능..했네 
	...
	int incorrectAnswers(char []answer, char []student_answer){
		return 10 - correctAnswers(answer, student_answer);//메소드안에서 메소드 호출가능
	}
...
class Exam
{
	public static void main(String[] args) 
	{
		...
		int cnt = util.correctAnswers(answer, student_answer); //메소드 호출!
